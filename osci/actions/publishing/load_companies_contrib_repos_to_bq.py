...
class LoadCompaniesContribReposToBQAction(Action):
    @classmethod
    def name(cls) -> str:
        return "load-companies-contributors-repositories-to-big-query"

    def _execute(self, day) -> Dict[str, Dict[str, Any]]:
        table = load_companies_contrib_repos_to_bq(date=day)
