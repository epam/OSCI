...
from __app__.transformers.rankers.repositories_ranking import get_repos_commits_amount
from .base import PushCommitsRankingJob


class ReposRankingJob(PushCommitsRankingJob):
    REPORT_NAME = 'repos_ranking'
