...
## NEWS UPDATE (April 7th 2020)

The OSCI ranking has now been updated with the data for March 2020.  
The latest ranking can be viewed on the EPAM SolutionsHub [OSCI page](https://solutionshub.epam.com/osci).
Alternatively the updated ranking can be downloaded (Excel format) from our [Archive folder](Archive): [2020.03 OSCI Ranking.xlsx](Archive/2020.03_OSCI_Ranking.xlsx).
